...
using Serilog;
using Tickets.Api.Api.Configuration;
using Tickets.Api.Api.Filters;
using Tickets.Api.Api.ModelBinders;
using Tickets.Api.Business.Identity;
using Tickets.Api.Business.Services;
...
namespace Tickets.Api.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ITicketMemberService, TicketMemberService>();
