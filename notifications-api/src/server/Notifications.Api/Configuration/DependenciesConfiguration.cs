...
using System.Linq;
using Notifications.Api.OperationFilters;
...
namespace Notifications.Api.Configuration
{
    public static class DependenciesConfiguration
    {
        ...
        public static void AddSwagger(this IServiceCollection services)
        {
            ...
            {
                setup.SwaggerDoc("v1", new Info { Title = "Notifications.Api", Version = "v1" });
                setup.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "Notifications.Api.Documentation.xml"));
