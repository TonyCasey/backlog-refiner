...
using System.Linq;
using TestCases.Api.OperationFilters;
...
namespace TestCases.Api.Configuration
{
    public static class DependenciesConfiguration
    {
        ...
        public static void AddSwagger(this IServiceCollection services)
        {
            ...
            {
                setup.SwaggerDoc("v1", new Info { Title = "TestCases.Api", Version = "v1" });
                setup.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "TestCases.Api.Documentation.xml"));
